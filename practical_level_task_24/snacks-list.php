    ...
    <div class="container-fluid">
        ...
        <div class="row heading-bg  bg-red">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-light">Snacks List</h5>
            </div>
            <!-- Breadcrumb -->
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="">Snacks</a></li>
                    <li class="active" href="#"><span>Snacks List</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-light">Snacks list table</h6>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered mb-0">
                                        ...
                                        <tr>
                                            <th>ID</th>
                                            <th>Snack Name</th>
                                            <th>Snack Meal Price</th>
                                            <th>Snack Sandwich Price</th>
...
<script>
    const tableBody = $('#snacks-table');
    const URL = "http://localhost/practical_level_task_24/apis/snacks/get-snacks.php";
    let request = $.ajax({
        url: URL,
        method: "POST",
        data: {},
    ...
    request.done(function (data) {
        if (parseInt(data['flag']) === 1) {
            for (let i = 0; i < data['snacks'].length; i++) {
                tableBody.append(createTableRow(data['snacks'][i]));
            }
        } else {
    ...
    function createTableRow(data) {
        ...
        tr.append('<td>' + data['snack_name'] + '</td>');
        tr.append('<td>' + data['meal_price'] + '</td>');
        tr.append('<td>' + data['sandwich_price'] + '</td>');
        ...
        deleteBtn.click(function () {
            const URL = "http://localhost/practical_level_task_24/apis/snacks/delete-snack.php";
            let request = $.ajax({
                url: URL,
                method: "POST",
                data: {
