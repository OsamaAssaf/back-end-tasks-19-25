        ...
        <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand">Our Works</a>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row custom-row">
                                    ...
                                    <div class="col-8">
                                        <input type="text" value="Title" name="title" id="title"  class="form-control form-control-sm"">
                                    </div>
                                </div>
                                <div class="row custom-row">
                                    <div class="col-2">
                                    ...
                                    <div class="col-8">
                                        <input type="text" value="Subtitle" name="subtitle" id="subtitle"  class="form-control form-control-sm"">
                                    </div>
                                </div>
                                <div class="row custom-row">
                                    <div class="col-2">
