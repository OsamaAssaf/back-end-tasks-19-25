                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row custom-row">
                                    ...
                                    <div class="col-8">
                                        <input type="text" value="Name" name="name" id="name"  class="form-control form-control-sm"">
                                    </div>
                                </div>
                                <div class="row custom-row">
                                    <div class="col-1">
                                    ...
                                    <div class="col-8">
                                        <input type="text" value="Feedback Text" name="feedback" id="feedback"  class="form-control form-control-sm"">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-1"></div>
