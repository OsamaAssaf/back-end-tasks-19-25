...
<div class="all-content-wrapper">
    ...
    createHeaderAdvance('Our Clients','fa-solid fa-people-robbery');
    ?>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="review-tab-pro-inner">
                            <ul id="myTab3" class="tab-review-design">
                                <li class="active"><a href="#add-client-feedback"><i class="fa-solid fa-circle-plus"></i> Add Client Feedback</a></li>
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="add-client-feedback">
                                    <form>
                                        <div class="row">
